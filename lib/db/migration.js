...
var Migration = Class.extend(/** @lends Migration# */{
  ...
  migrate: function() {
    ...
    // module.up(schema);
    // Also see the .catch that's commented out below for how to roll back.
    ...
    // .catch(function(e) {
    //   return schema.rollback().execute().throw(e);
    // });
  },
  ...
  rollback: function() {
    // TODO: make this all happen in a transaction
    var batch;
    return this._loadExecutedMigrations().bind(this).tap(function(migrations) {
