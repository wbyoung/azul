...
var MySQLAdapter = Adapter.extend(/** @lends MySQLAdapter# */ {
   ...
   */
  _execute: BluebirdPromise.method(function(connection, sql, args) {
    ...
    .spread(function(rows, fields) {
      if (rows.insertId) {
        // TODO: how to make MyQL and PG more similar for insert queries?
        // TODO: can we make this not id and instead the column name?
