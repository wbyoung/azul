...
Adapter.reopen(/** @lends Adapter# */ {
   ...
   * _client_ object will also be passed to {@link-to #_disconnect} and
   * {@link-to #_execute} for subclass use.
   *
   ...
   * {@link-to Adapter~ExecutionResult}.
   */
   ...
   * properties defined by {@link-to Adapter~ExecutionResult}.
   *
   * The `client` object is the object that was created from a
   * {@link-to #_connect}.
   *
