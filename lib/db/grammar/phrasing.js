 ...
 */
Phrasing.prototype.where = function(condition) {
 ...
 */
Phrasing.prototype.join = function(join) {
...
Phrasing.prototype.select = function(data) {
  ...
  var fragments = [Fragment.create(util.format('select %s from %s', quotedColumns.join(', '), tables.join(', ')))];
...
Phrasing.reopenClass({ __name__: 'Phrasing' });
