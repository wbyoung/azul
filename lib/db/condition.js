 ...
 * @function
 * @private
 * @param {(Object|Condition|Operation)[]} parts The array of parts to convert.
 * @return {(Node|Operation)[]} The parts with all appropriate types converted
 * to syntax nodes.
 */
 ...
 * @function
 * @private
 * @param {(Node|Operation)[]} parts The array of parts to convert.
 * @return {(Node|Operation)[]} The parts with all appropriate types converted
 * to syntax nodes.
 */
