...
module.exports = Mixin.create(/** @lends HasMany# */ {
  ...
  associateObjects: throughOverride(function(instance, objects, options) {
    ...
    var action = Actionable.create(function() {
    ...
    this.beforeSavingActions(instance, [action]);
  }),
  ...
  disassociateObjects: throughOverride(function(instance, objects, options) {
    ...
    var action = Actionable.create(function() {
      ...
      .then(function() {
        ...
        var fks = _(objects).map('pk').filter().value();
  ...
  clearObjects: throughOverride(function(instance) {
    this._cacheObjectsQuery(instance, undefined); // TODO: move?
    ...
    var action = Actionable.create(function() {
      ...
      return sourceRelation._modelClass.objects.where(where).delete();
    });

    this._clearCollectionCache(instance); // TODO: move
