...
module.exports = Mixin.create(/** @lends HasMany# */ {
   ...
   */
  scopeObjectQuery: throughOnly(function(instance, query) {
  ...
  beforeAssociatingObjects: function(/*instance, objects, options*/) {
    ...
    if (this._options.through) {
      this._associateObjectsThrough.apply(this, arguments);
    }
  },

  // TODO: docs
  _associateObjectsThrough: function(instance, objects, options) {
  ...
  beforeDisassociatingObjects: function(/*instance, objects, options*/) {
    ...
    if (this._options.through) {
      this._disassociateObjectsThrough.apply(this, arguments);
    }
  },

  // TODO: docs
  _disassociateObjectsThrough: function(instance, objects, options) {
    var opts = _.defaults({}, options, { follow: true, attrs: true });
    var throughRelations = this._throughRelations();
