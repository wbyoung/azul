...
module.exports = Mixin.create(/** @lends HasMany# */ {
   ...
   *
   * Mixins can override {@link HasMany#prefetchAssociate} to change the way
   * pre-fetch association is performed. This is the default implementation.
   *
   * @method
   * @protected
   * @see {@link BaseRelation#prefetchAssociate}
   */
  _prefetchAssociate: function(instances, grouped) {
