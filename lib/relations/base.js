...
BaseRelation.reopenClass(/** @lends BaseRelation */ {
  ...
  /**
   * A helper for a getter that can be used with {@link BaseRelation.property}.
   *
  ...
  /**
   * A helper for a setter that can be used with {@link BaseRelation.property}.
   *
  ...
  /**
   * This is the same as {@link BaseRelation.helper}, but for properties.
   *
   * @method
   * @protected
  ...
  /**
   * A helper method that can be used with {@link BaseRelation.property}.
   *
  ...
  /**
   * Convenience method for defining helper methods that should be available
   * via {@link BaseRelation#methods}.
   *
   ...
   *     CustomRelation.reopenClass({
   *       methods: {
   *         'get<Singular>': BaseRelation.helper('get'),
   *         'set<Singular>': BaseRelation.helper('set')
   *       }
   *     });
   *
   * @method
   ...
   * {@link BaseRelation#method}.
   *
   * @function BaseRelation~MethodOverrideHelper
   * @param {BaseRelation} relation The relation.
   * @return {Function} The method that will be added to the model class.
   */

  /**
   * A variation of {@link BaseRelation.helper} that makes it a little easier
   * to work with the model instance and arguments. In many cases, this will
   * make it more clear that the method is actually operating on a model via
   * a relation.
   *
   *     CustomRelation.reopen({
   ...
   * {@link BaseRelation~MethodOverrideHelper} to call on the relation.
   * @return {BaseRelation~MethodCallable}
   */
