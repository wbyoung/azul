...
BaseRelation.reopenClass(/** @lends BaseRelation */ {
  ...
  /**
   * Subclasses should override this to indicate whether the model class is is
   * associated with the table in the database that defines the foreign key
   * column.
   *
   * @type {Boolean}
   * @protected
   */
  hostsForeignKey: property(function() {
    if (this._hostsForeignKey === undefined) {
      throw new Error('The `hostsForeignKey` property must be defined ' +
        'by subclasses');
    }
    return this._hostsForeignKey;
  }, { writable: true })
