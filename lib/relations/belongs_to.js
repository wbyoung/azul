...
BelongsTo.reopenClass(/** @lends BelongsTo */ {
  ...
  methods: {
    ...
    'get<Singular>': BaseRelation.helper('item'),
    'set<Singular>': BaseRelation.helper('set'),
    'create<Singular>': BaseRelation.helper('create'),
    'fetch<Singular>': BaseRelation.helper('fetch'),
    ...
    _presave: BaseRelation.method('presave'),
