...
/**
 * A basic hook with no default value.
 *
 * @function HasMany~hook
 * @private
 */
var hook = function() {
...
/**
 * An overridable hook which calls `_<name>` to get the default value.
 *
 * @function HasMany~hook
 * @private
 */
...
module.exports = Mixin.create(/** @lends HasMany# */ {
  ...
  /**
   * This method is overridable my mixins. See the default implementation,
   * {@link HasMany#_inverseDefault} for more details. Mixins should either
   * call super or fully handle the calculation of the default.
   *
   * @method
   * @protected
   * @see {@link HasMany#_inverseDefault}
   */
  inverseDefault: overridable('inverseDefault'),

  /**
   * This method is overridable my mixins. See the default implementation,
   * {@link HasMany#_primaryKeyDefault} for more details. Mixins should either
   * call super or fully handle the calculation of the default.
   *
   * @method
   * @protected
   * @see {@link HasMany#_primaryKeyDefault}
   */
  primaryKeyDefault: overridable('primaryKeyDefault'),

  /**
   * This method is overridable my mixins. See the default implementation,
   * {@link HasMany#_foreignKeyDefault} for more details. Mixins should either
   * call super or fully handle the calculation of the default.
   *
   * @method
   * @protected
   * @see {@link HasMany#_foreignKeyDefault}
   */
  foreignKeyDefault: overridable('foreignKeyDefault'),
  ...
  /**
   * Actions to take before creating an object for the relation when
   * specifically requested via {@link HasMany#createObject}. Mixins can define
   * this method (and call super) to take action before the creation of an
   * object for the relationship. Note that there is no after hook since the
   * created object is not associated with the instance & the user is free to
   ...
   * @param {Array.<Model>} objects The objects being added.
   */
  beforeCreatingObject: hook,

  /**
   * Actions to take before adding objects to the relation when specifically
   * requested via {@link HasMany#addObjects}. Mixins can define this method
   * (and call super) to take action before the addition of objects to the
   * relationship.
   *
   * @method
   * @protected
  ...
  /**
   * Actions to take after adding objects to the relation & saving the instance
   * when specifically requested via {@link HasMany#addObjects}. Mixins can
   * define this method (and call super) to take action after the addition of
   ...
   * define this method (and call super) to take action before the removal of
   * objects from the relationship.
   *
   * @method
   * @protected
   * @param {Model} instance The model instance on which to operate.
  ...
  /**
   * Actions to take after removing objects to the relation & saving the
   * instance when specifically requested via {@link HasMany#removeObjects}.
   * Mixins can define this method (and call super) to take action after the
   * removal of objects from the relationship.
   *
   * @method
   * @protected
   * @param {Model} instance The model instance on which to operate.
   ...
   * define this method (and call super) to take action before the clearing of
  ...
  /**
   * Actions to take after clearing objects in the relation & saving the
   * instance when specifically requested via {@link HasMany#clearObjects}.
   * Mixins can define this method (and call super) to take after the clearing
   * of objects in the relationship.
   *
   * @method
   * @protected
   * @param {Model} instance The model instance on which to operate.
