...
module.exports = Mixin.create(/** @lends HasMany# */ {
  ...
  /**
   * This method is overridable my mixins. See the default implementation,
   * {@link HasMany#_prefetchAssociate} for more details. Mixins should either
   * call super or fully handle pre-fetch association.
   *
   * @method
   * @protected
   * @see {@link HasMany#_prefetchAssociate}
   */
  prefetchAssociate: overridable('prefetchAssociate'),
