...
module.exports = Mixin.create(/** @lends HasMany# */ {
  ...
  // TODO: docs
  performAdd: overridable('performAdd'),

  // TODO: docs
  performRemove: overridable('performRemove'),

  // TODO: docs
  performClear: overridable('performClear'),
  ...
  // TODO: docs
  associateObjectForeignKey: overridable('associateObjectForeignKey'),
  ...
  // TODO: docs
  disassociateObjectForeignKey: overridable('disassociateObjectForeignKey'),
