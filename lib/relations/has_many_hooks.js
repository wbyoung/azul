...
module.exports = Mixin.create(/** @lends HasMany# */ {
  ...
  /**
   * Mixins can override this method to apply a more specific scope for the
   * search of objects. The default implementation simply calls a method by the
   * same name with a leading `_` prefix.
   *
   * @method
   * @protected
   ...
   */
  scopeObjectQuery: function(/*query, ids*/) {
    return this._scopeObjectQuery.apply(this, arguments);
  },
