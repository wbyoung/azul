...
HasMany.reopen(/** @lends HasMany# */ {
   ...
   * @see {@link BaseRelation#methods}
   */
  _createObject: invalidatesQuery(function(instance) {
   ...
   * @see {@link BaseRelation#methods}
   */
  _addObjects: invalidatesQuery(function(instance) {
    var args = _.rest(arguments);
   ...
   */
  _executeAdd: invalidatesQuery(function(instance, objects) {
    var self = this;
   ...
   * @see {@link BaseRelation#methods}
   */
  _removeObjects: invalidatesQuery(function(instance) {
    var args = _.rest(arguments);
    var objects = _.flatten(args, true);
   ...
   */
  _executeRemove: invalidatesQuery(function(instance, objects) {
    var self = this;
   ...
   * @see {@link BaseRelation#methods}
   */
  _clearObjects: invalidatesQuery(function(instance) {
   ...
   * @param {Model} instance The model instance on which to operate.
   */
  _executeClear: invalidatesQuery(function(instance) {
