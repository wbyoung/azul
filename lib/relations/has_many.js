...
/**
 * This wrapper method is used to immediately invalidate the objectsQuery cache
 * when performing any sort of update to related objects.
 *
 * @since 1.0
 * @private
 * @method
...
HasMany.reopen(/** @lends HasMany# */ {
  ...
  _alterCollectionCache: function(instance, fn) {
    var value = instance[this._collectionCacheKey(instance)];
