...
var pushAll = Array.prototype.push.apply.bind(Array.prototype.push);
var pullAll = function(arr, objs) { _.pull.apply(_, [arr].concat(objs)); };
...
HasMany.reopen(/** @lends HasMany# */ {
   ...
   * @method
   */
  // TODO: this could be a property created during init instead of recalculated
  _objectsQueryCacheKey: function() {
    return '_' + _.str.camelize(this._name + '_objectsQueryCache');
  },
  ...
  addObjects: function(instance, args) {
    ...
    return this._updateRelatedObjects(instance, objects)
    .tap(function() {
      if (instance[cacheName]) {
        pushAll(instance[cacheName], objects);
      }
    });
  },
  ...
  removeObjects: function(instance, args) {
    ...
    return this._updateRelatedObjects(undefined, objects)
    .tap(function() {
      if (instance[cacheName]) {
        pullAll(instance[cacheName], objects);
      }
    });
  },
  ...
  clearObjects: function(instance/*, args*/) {
    ...
    return query.delete().execute().tap(function() {
      if (instance[cacheName]) {
        instance[cacheName].splice(0);
      }
    });
  },
