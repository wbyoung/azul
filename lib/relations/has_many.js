...
HasMany.reopen(/** @lends HasMany# */ {
  ...
  addObjects: invalidatesQuery(function(instance, args) {
    ...
    .then(this._beforeAddingObjects.bind(this, instance, objects))
    .then(this._prepareForForeignKeyUpdate.bind(this, instance, objects))
    .then(this._updateForeignKeys.bind(this, instance, objects, instance.id));
  }),
  ...
  removeObjects: invalidatesQuery(function(instance, args) {
    var objects = _.flatten(args, true);
    return BluebirdPromise.bind()
    .then(this._beforeRemovingObjects.bind(this, instance, objects))
    .then(this._prepareForForeignKeyUpdate.bind(this, instance, objects))
    .then(this._updateForeignKeys.bind(this, instance, objects, undefined));
  }),
  ...
  clearObjects: invalidatesQuery(function(instance/*, args*/) {
    // TODO: update associations before rather than after
