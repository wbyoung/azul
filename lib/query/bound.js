...
var SelectQuery = require('maguey').SelectQuery;
var InsertQuery = require('maguey').InsertQuery;
var UpdateQuery = require('maguey').UpdateQuery;
var DeleteQuery = require('maguey').DeleteQuery;
var RawQuery = require('maguey').RawQuery;
