...
module.exports = Mixin.create(/** @lends ModelQuery# */ {
   ...
   * just kicks off the start of a {@link ModelQuery#_prefetchAssociation}
   * using the records that was passed to it.
   *
   * @method
   * @private
  ...
  /**
   * Associates all pre-fetched values for each association in the given
   * association string. Pre-fetched values will be loaded from the cache.
   *
   * @method
   * @private
