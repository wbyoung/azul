...
var AttributeTrigger = Class.extend(/** @lends AttributeTrigger# */{
   ...
   * is being added.
   * @param {Object} details.identity The class object to which the property
   * is being added. Note that from this property alone it is impossible to
   * tell if the attribute is being added as an instance attribute or a
