...
var reopen = function(properties, cls, superClass, options) {
  ...
  if (opts.wrap) {
    properties = wrap.super.properties(properties, cls.prototype);
  }
...
var _super = function() {
  ...
  return function() {
    var ret;
    if (fn) {
      self.__superFunction = null;
      ret = fn.apply(self, arguments);
      self.__superFunction = fn;
    }
    return ret;
  };
};

var accessor = function(on) {
  return function() {
 ...
 */
Meta.prototype.defineAccessor = accessor('__class__');

/**
 * Define a static accessor. This will define a property that reads and/or
 * writes to a private static instance variable.
 *
 * @method Class.defineClassAccessor
 * @see {@link Class.defineAccessor}
 */
Meta.prototype.defineClassAccessor = accessor('__metaclass__');
