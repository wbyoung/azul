...
var Mixin; // circular dependency required after export
...
Meta.prototype.extend = function(properties, classProperties) {
  ...
  // process mixin arguments
  var args = Array.prototype.slice.call(arguments);
  var mixins = [];
  while (Mixin && args[0] instanceof Mixin.__class__) {
  ...
  mixins.forEach(function(mixin) { cls.reopen(mixin.properties); });
...
Mixin = require('./mixin'); // circular dependency required after export
Mixin.wrap = wrap; // TODO: don't share wrap with the mixin class this way
