 ...
 * numerical representations between 0 and 7, starting with Sunday and
 * ending with Saturday.
 * 
 * @function weekdayToNumberConverter
 ...
 * @example
 *
 * weekdayToNumberConverter('Sunday');
 *
 * /=> 0
 *  
 */

function weekdayToNumberConverter(weekday) {
...
module.exports = {
  weekdayToNumberConverter: weekdayToNumberConverter
};
