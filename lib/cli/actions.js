 ...
 * @param {String} action Either `migrate` or `rollback`.
 * @param {Object} azulfile Configuration object.
 * @param {Object} options
 * @param {String} options.migrations
 * @param {Object} strings The output format strings to use.
 * @return {Promise}
 */
...
/**
 * Initialization CLI action.
 *
 * @public
 * @function
 * @param {Object} options
 * @param {String} db The database adapter name to use.
 */
module.exports.init = function(options, db) {
  db = require('maguey').adapters.aliases[db || 'pg'];
