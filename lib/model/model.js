 ...
 *     // -> select * from "articles" inner join "blogs" on "articles"."blog_id" = "blogs"."id"
 ...
 *     // -> select * from "employees" inner join "employees" "managers"
 ...
 *     // -> select * from "nodes" "t1" inner join "nodes" "t2"
 *     // -> on "t1"."node_id" = "t2"."id"
 *     // -> where "t2"."id" = ?
 *     // !> [1]
 *
 ...
 *     // -> select * from "nodes" where "nodes"."id" = ?
 *     // !> [1]
 *
 * @public
 * @constructor Model
