...
var Model = Class.extend(/** @lends Model# */ {
  ...
  save: function(options) {
    ...
    if (!this.persisted || this.dirty || opts.force) {
      query = this.__identity__.objects.insert(this.attrs)
      .then(function(/*result*/) {
        // TODO: get an actual value out of the result. this may require
        // changing the way that the transformations are set up so that they
